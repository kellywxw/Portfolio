	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (itemId == null || itemId.trim().isEmpty()) {
        	...
        	try {
        		...
        		if(item == null) {
        			messages.put("success", "Task " + itemId + " does not exist.");
        		}
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (itemId == null || itemId.trim().isEmpty()) {
        	...
        	try {
        		...
        		Items item = itemsDao.getItemByItemId(itemID);
        		if(item == null) {
        			messages.put("success", "Task " + itemId + " does not exist. No update to perform.");
        		} else {
        			...
        			if (newDescription == null || newDescription.trim().isEmpty()) {
        	        	...
        	        	messages.put("success", "Successfully updated Task " + itemId);
        	        }
        		}
        		req.setAttribute("item", item);
        	} catch (SQLException e) {
